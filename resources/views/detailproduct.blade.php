            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-[#FE9494] hover:text-[#FE7070] md:ms-2">Detail Product</a>
                    </div>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="data w-full max-w-xl" x-data="{ quantity: 2 }">
                            ...
                            <div class="flex items-center mb-6">
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="text-gray-500 ml-2">• 20 Reviews</span>
                                </div>
                            </div>
                            
                            <p class="text-[#505050] text-base font-normal mb-8">
                                Made with real meat and essential nutrients for a healthy, happy dog. High in protein, grain-free, and enriched with Omega-3 & 6 for a shiny coat. Supports digestion and immune health with prebiotics and vitamins. Perfect for all breeds!
                            </p>
                            ...
                            <div class="flex gap-5">
                                <button class="bg-white text-gray-800 font-medium py-3 px-4 w-32 border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 transition-all duration-200 flex items-center justify-center text-sm">
                                    ADD TO CART
                                </button>
                                <button class="bg-gray-800 text-white font-medium py-3 px-4 w-32 border border-gray-800 rounded-lg shadow-sm hover:bg-gray-700 transition-all duration-200 flex items-center justify-center text-sm">
                                    BUY NOW
                                </button>
                            </div>
                        </div>
