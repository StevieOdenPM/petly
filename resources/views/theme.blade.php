...
<x-main>
    <div class="flex gap-12 max-w-7xl w-full mt-12 mb-32 mx-auto flex-grow">
        ...
        <aside class="user-profile bg-white dark:bg-gray-800 dark:text-white shadow-md rounded-xl p-6 w-80 flex flex-col items-center self-start">
            ...
            <nav class="space-y-4 w-full">
                ...
                <a href="/theme" class="flex items-center gap-2 text-red-500 font-semibold px-4 py-2 rounded-lg relative group">
        ...
        <main class="flex-1">
            <!-- Appearance Section -->
            <div class="theme-container bg-white dark:bg-gray-800 dark:text-white p-8 lg:p-10 rounded-xl shadow-md max-w-4xl w-full">
                ...
                <div class="flex gap-6 items-center justify-center mb-6">
                    <label class="cursor-pointer">
                        ...
                        <div class="p-6 rounded-lg border w-24 h-24 flex items-center justify-center dark:border-gray-600">
            ...
            <div class="pagedone-container bg-white dark:bg-gray-800 dark:text-white p-8 lg:p-10 rounded-xl shadow-md max-w-4xl w-full mt-20">
                <h2 class="text-lg font-semibold mb-4">Data & Storage</h2>
                <button class="w-full p-4 bg-yellow-100 dark:bg-yellow-900 dark:text-yellow-200 text-gray-800 rounded-lg flex items-center gap-3">
                    <i data-lucide="trash"></i>
                    <div class="flex flex-col text-left">
                        <p class="font-semibold">Clear cache data</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Quick solution to solve application problems</p>
                    </div>
                </button>
            </div>
        </main>
