        ...
        <div class="flex-1 px-4 py-8">
            <div class="max-w-3xl mx-auto">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="/admin/product" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-lg shadow-sm hover:bg-gray-400 transition">
                        ← Previous
                    </a>
                </div>
                ...
                <div class="p-6 bg-white rounded-xl shadow-md">
                    <form action="{{ route('product.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="product_image" class="w-full border rounded p-2" placeholder="https://example.com/image.jpg" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="product_rating" min="0" max="10" step="0.1" class="w-full border rounded p-2" placeholder="Contoh: 4.5">
                        </div>
                        ...
                        <div class="text-right">
                            <button type="submit" class="px-4 py-2 bg-red-400 text-white rounded-lg shadow-sm hover:bg-red-500">
                                Simpan Produk
                            </button>
                        </div>
                    </form>
