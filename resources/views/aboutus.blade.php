<x-main>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pb-15">
        ...
        <div x-data="{ hovered: false }" @mouseenter="hovered = true" @mouseleave="hovered = false"
            ...
            <img :src="hovered ? '{{ URL('img/image.png') }}' : '{{ URL('img/imageun.png') }}'"
                alt="team member" class="w-[395px] h-[455px] object-contain transition-transform duration-300 group-hover:scale-105">
            
            <!-- card (hidden until hover) -->
            <div class="absolute bottom-5 bg-white py-2 px-4 rounded-md shadow-md flex items-center justify-between w-[80%] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div>
        ...
        <div x-data="{ hovered: false }" @mouseenter="hovered = true" @mouseleave="hovered = false"
            class="bg-[#FFE3E1] rounded-[20px] overflow-hidden p-5 flex items-center justify-center relative group transition-all duration-300 hover:shadow-xl">
            <img :src="hovered ? '{{ URL('img/image.png') }}' : '{{ URL('img/imageun.png') }}'"
                alt="Stevie Oden Patric" class="w-[395px] h-[455px] object-contain transition-transform duration-300 group-hover:scale-105">
